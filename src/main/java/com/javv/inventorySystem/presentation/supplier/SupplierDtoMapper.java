...
public class SupplierDtoMapper {
  ...
  public SupplierUpdateAddressCommand toAddressUpdateCommandRecord(
      SupplierUpdateAddressDto supplierUpdateAddressDto) {

    return new SupplierUpdateAddressCommand(
        supplierUpdateAddressDto.street(),
        supplierUpdateAddressDto.city(),
        supplierUpdateAddressDto.state(),
        supplierUpdateAddressDto.postalCode(),
        supplierUpdateAddressDto.country());
  }
