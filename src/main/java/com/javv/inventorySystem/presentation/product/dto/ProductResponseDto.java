...
public record ProductResponseDto(
    ...
    @NotNull(
      message = "Product Response DTO: Base Unit of Measure ID is required for response.")
    int baseUnitOfMeasureId,

    @NotBlank(
      message = "Product Response DTO: Base Unit of Measure is required for response.") 
